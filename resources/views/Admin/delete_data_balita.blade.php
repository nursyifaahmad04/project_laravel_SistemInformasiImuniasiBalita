            ...
            <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--6-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h1 class="mdl-card__title-text">Hapus Data Balita Imunisasi</h1>
                    </div>
                    <div class="mdl-card__supporting-text no-padding">
                        <table class="mdl-data-table mdl-js-data-table bordered-table">
                            ...
                            <tr>
                                ...
                                <th class="mdl-data-table__cell--non-numeric" style="text-align:center">Hapus</th>
                            </tr>
                            </thead>
                            <tbody>
                                <tr>
                            <?php $no = 1; ?>
                                 @foreach ($balita as $data)
                                    ...
                                    <td class="mdl-data-table__cell--non-numeric">
                                        ...
                                        onclick="window.location.href='/balita/destroy/{{ $data->id_balita }}'" >
